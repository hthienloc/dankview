...
Singleton {
    ...
    readonly property string systemFontFamily: Quickshell.env("DPLAY_FONT_FAMILY") || ""
    readonly property real systemFontScale: {
        const s = parseFloat(Quickshell.env("DPLAY_FONT_SCALE"));
    ...
    property string monoFontFamily: Quickshell.env("DPLAY_MONO_FONT") || ((dmsSettings && dmsSettings.monoFontFamily) ? dmsSettings.monoFontFamily : defaultMonoFontFamily)
